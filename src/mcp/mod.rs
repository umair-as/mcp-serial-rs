...
//! `tools/list` / `tools/call` framing; all seven `serial.*` tools are
...
impl<B: SerialBackend> McpServer<B> {
    ...
    /// array contract.
    ///
    /// No output schema is declared — input schemas are generated by
    /// rmcp; output schemas are not implemented.
    #[tool(
